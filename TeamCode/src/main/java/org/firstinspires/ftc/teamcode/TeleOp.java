...
public class TeleOp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(inp.getVoltage() - targetPosition < 0.1 && targetPosition == wobbleMech.upperBound)
                arm.setVelocity(-100);
            else if(inp.getVoltage() - targetPosition < 0.1 && targetPosition == wobbleMech.lowerBound)
                arm.setVelocity(100);
            else
                arm.setVelocity(0);

            if(inp.getVoltage() - wobbleMech.lowerBound < -0.1 || inp.getVoltage() - wobbleMech.upperBound > 0.1)
                arm.setVelocity(0);
